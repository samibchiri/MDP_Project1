...
statespaceLength=np.linspace(0,20,20)

#Compute discrete probabilities based on gamma distribution
prob = gamma.cdf(statespaceLength+0.5, param[0], param[1], param[2]) - gamma.cdf(statespaceLength-0.5, param[0], param[1], param[2])
